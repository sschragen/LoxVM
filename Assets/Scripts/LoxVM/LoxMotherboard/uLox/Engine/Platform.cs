...
namespace ULox
{
    public interface IPlatformLibraries
    {
        void AddLibraries (Context executionContext);
    }
    ...
    public interface IPlatform : IPlatformFiles, IPlatformIO, IPlatformLibraries, IPlatformConfig
    {
    }
