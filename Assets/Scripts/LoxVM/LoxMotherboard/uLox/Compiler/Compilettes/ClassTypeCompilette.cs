...
namespace ULox
{
    public sealed class ClassTypeCompilette : TypeCompilette
    {
        ...
        public static readonly HashedString SuperName = new("super");
        ...
        {
            if (CurrentTypeName == null)
                compiler.ThrowCompilerException("Cannot use the 'super' keyword outside of a class");
            compiler.NamedVariable(SuperName.String, canAssign);
        }
        ...
        /*
        protected void DoDeclareTypeOld(Compiler compiler)
        {
        ...
        */
        protected override void DoDeclareType(Compiler compiler)
        {
            Stage = TypeCompiletteStage.Begin;
